...
%% 画自相关函数
figure;
plot(tao/Tc,corrResults_BOC,'LineWidth',2);legend('BOC(1,1)');xlabel('Code Delay(Tc)');ylabel('Normalized Auto Correlation Function');grid on;axis([-1.05,1.05,-.6,1.05]);saveas(gcf,'ACF_BOC11.fig'); 
