...
%% 画自相关函数
figure;
plot(tao/Tc,corrResults_BOC,'LineWidth',2);legend('BOC(10,5)');xlabel('Code Delay(Tc)');ylabel('Normalized Auto Correlation Function');grid on;axis([-1.05,1.05,-.8,1.05]);saveas(gcf,'ACF_BOC105.fig'); 
