...
%% 画自相关函数
figure;
plot(tao/Tc,corrResults_BOC,'LineWidth',2);legend('BOC(14,2)');xlabel('Code Delay(Tc)');ylabel('Normalized Auto Correlation Function');grid on;axis([-1.05,1.05,-.05,1]);saveas(gcf,'ACF_BPSK1.fig'); 
